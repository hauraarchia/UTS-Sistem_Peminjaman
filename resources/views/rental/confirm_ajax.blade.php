...
@else 
    <form action="{{ url('/rental/' . $rental->id_rental.'/delete_ajax') }}" method="POST" id="form-delete"> 
    @csrf 
    @method('DELETE') 
    <div id="modal-master" class="modal-dialog modal-lg" role="document"> 
        <div class="modal-content"> 
            ...
            <div class="modal-body"> 
                ...
                <table class="table table-sm table-bordered table-striped"> 
                    {{-- <tr>
                        ...
                        <td class="col-9">{{ $rental->level->level_nama }}</td>
                    </tr>  --}}
                    <tr>
                        <th class="text-right col-3">NIM:</th>
                        <td class="col-9">{{ $rental->mahasiswa->id_mahasiswa}}</td>
                    </tr> 
                    <tr>
